...
# Filer file to only 2007-02-01 and 2007-02-02 dated samples
householdConsumption <- read.csv2.sql(connection = sqldfConnection, dbname = tempfile(), sql = "select * from dataFileConn where Date = '1/2/2007' or Date = '2/2/2007'", overwrite=TRUE)
